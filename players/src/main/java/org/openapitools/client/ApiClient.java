...
public class ApiClient {
    ...
    private String basePath = "https://api.tournamentsoftware.com/1.0";
    ...
    public ApiClient() {
        ...
        authentications.put("ts_auth", new HttpBasicAuth());
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://1.0
